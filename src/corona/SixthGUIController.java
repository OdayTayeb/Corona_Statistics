...
public class SixthGUIController implements Initializable{
    @FXML
    private BarChart<?, ?> bc;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        for(Stats x : SAsia){
            ...
            int year = x.getYear() ;
            long Deaths = x.getDeaths();  
            asia.getData().add(new XYChart.Data(day + "/" + month + "/" + year ,Deaths)) ;
        }
        for(Stats x : SEurope){
            int day = x.getDay() ;
            int  month = x.getMonth() ;
            int year = x.getYear() ;
            long Deaths = x.getDeaths() ;
            europe.getData().add(new XYChart.Data(day + "/" + month + "/" + year ,Deaths)) ;
        }
        for(Stats x : SAfrica){
            int day = x.getDay() ;
            int  month = x.getMonth() ;
            int year = x.getYear() ;
            long Deaths = x.getDeaths() ;  
            africa.getData().add(new XYChart.Data(day + "/" + month + "/" + year ,Deaths)) ;
        }
        for(Stats x : SAmerica){
            ...
            int year = x.getYear() ;
            long Deaths = x.getDeaths() ;  
            america.getData().add(new XYChart.Data(day + "/" + month + "/" + year ,Deaths)) ;
        }
        for(Stats x : SOceania){
            ...
            int year = x.getYear() ;
            long Deaths = x.getDeaths() ;  
            oceania.getData().add(new XYChart.Data(day + "/" + month + "/" + year ,Deaths)) ;
        }
